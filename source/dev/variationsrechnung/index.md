...
Die Variationsrechnung erweitert den klassischen Werkzeugkasten der Analysis um eine entscheidende Idee:\
Nicht mehr eine **Zahl** wird so gewählt, dass eine Funktion minimal wird, stattdessen wird eine **ganze Funktion** bzw. **Bahn** gesucht, die eine **globale Größe** extremal macht.
...
Hier kommen zwei Grafiken hin: (1) Seil zwischen zwei Punkten (Längen-/Energieprinzip),  
(2) Brechung an einer Grenzfläche (Zeitprinzip / Fermat).
```
